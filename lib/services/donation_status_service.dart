...
class DonationStatusService {
  ...
  // Add this method to your existing DonationStatusService class:

// Get donation statuses for a specific user as a Future (for mobile app)
  Future<List<DonationStatus>> getUserDonationStatusesFuture(
      String userId) async {
    try {
      QuerySnapshot snapshot = await _firestore
          .collection('donationStatuses')
      ...
      print('Error getting user donation statuses: $e');
      return [];
    }
  }
}
